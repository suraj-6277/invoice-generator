...
export const NewInvoiceForm = () => {
  ...
  useEffect(() => {
    console.log("[NewInvoiceForm] useEffect on server? window exists?", typeof window !== "undefined");
  }, []);

  console.log("[NewInvoiceForm] render isClient", isClient);
  return (
    <>
      {isClient ? (
            ...
            <div>
              <div className="flex gap-2 items-center">
                ...
                <div>
                  ...
                  <p className="text-primary text-sm">By Suraj Jadhav</p>
                </div>
              </div>
              <UserInputForm />
            </div>
