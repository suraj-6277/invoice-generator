...
import DemoPreview from "./(landing)/components/demoPreview";
      ...
      <div className="border-l border-r max-w-4xl w-full mx-auto border-dashed h-full flex justify-center flex-col border-gray-300">
        <div className="justify-center items-center h-full flex flex-col my-10">
          ...
          <div className="relative group">
            <h1 className="font-semibold text-3xl md:text-7xl text-center w-full border-t border-b py-6 border-dashed text-balance px-4 text-black border-gray-300">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-br from-accent to-indigo-500">
                Invoice Generator
              </span>
            </h1>
          </div>
          <div className="pt-10 pb-11 flex gap-3 items-center mx-auto border-gray-300 border-b w-full justify-center border-dashed relative">
            ...
            <Link
              href="/new"
              className="inline-flex items-center justify-center whitespace-nowrap rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring font-medium disabled:pointer-events-none disabled:opacity-50 bg-gradient-to-br from-accent to-indigo-500 text-white hover:bg-black/90 px-6 py-2 text-lg"
            >
              Generate Invoice
            </Link>
            <Link
              href="https://github.com/suraj-6277/invoice-generator"
              target="_blank"
              className="inline-flex items-center justify-center whitespace-nowrap rounded-lg border border-gray-300 bg-white text-black hover:bg-gray-100 px-6 py-2 text-lg"
            >
              Github
            </Link>
          </div>
        ...
        <div className="grid sm:grid-cols-2 relative">
          ...
          <div className="border-r border-b border-dashed p-7 border-gray-300 flex justify-center flex-col items-center">
            <p className="border flex justify-center items-center w-11 h-11 border-dashed rounded-lg text-2xl mb-5 border-gray-300 bg-gradient-to-br from-accentLight to-indigo-100">
              <Rocket />
            </p>
        ...
        <div className="px-5 py-11 flex justify-center items-center border-b border-dashed border-gray-300">
            <div className="flex justify-center rounded-2xl max-w-3xl border-dashed items-center px-4 py-10 w-full flex-col gap-4  bg-gradient-to-br from-accentLight to-indigo-100">
        ...
        <div className="flex justify-center items-center border-b border-dashed mb-20 border-gray-300 py-10 px-4 gap-4">
          ...
          <div className="border flex justify-center items-center w-10 h-10 border-dashed rounded-lg text-2xl border-gray-300">
            <a target="_blank" href="https://in.linkedin.com/in/surajjadhav7">
              <Linkedin />
            </a>
          </div>
          <div className="border flex justify-center items-center w-10 h-10 border-dashed rounded-lg text-2xl border-gray-300">
            <a target="_blank" href="https://x.com/surajjadhav_07">
              <Twitter />
            </a>
          </div>
        </div>
